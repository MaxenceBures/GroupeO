...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CjVd8l5F9p', 0, (__DIR__.'/pools'));
    ...
    protected function getDoctrine_Dbal_EniConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.auto_mapping_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.auto_mapping_listeners.attach_entity_listeners'] : $this->get('doctrine.orm.auto_mapping_listeners.attach_entity_listeners')) && false ?: '_'});
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.eni_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.eni_listeners.attach_entity_listeners'] : $this->get('doctrine.orm.eni_listeners.attach_entity_listeners')) && false ?: '_'});

        return $this->services['doctrine.dbal.eni_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'localhost\\CLAAS', 'port' => NULL, 'dbname' => 'ENI_db', 'user' => 'Alois', 'password' => 'Test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Dbal_GroupeoConnectionService()
    {
        $a = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.auto_mapping_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.auto_mapping_listeners.attach_entity_listeners'] : $this->get('doctrine.orm.auto_mapping_listeners.attach_entity_listeners')) && false ?: '_'});
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.groupeo_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.groupeo_listeners.attach_entity_listeners'] : $this->get('doctrine.orm.groupeo_listeners.attach_entity_listeners')) && false ?: '_'});

        return $this->services['doctrine.dbal.groupeo_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'localhost\\CLAAS', 'port' => NULL, 'dbname' => 'GroupeO', 'user' => 'Alois', 'password' => 'Test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_AutoMappingMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_auto_mapping_659db4820391ac47ebda3e45c48dd246fc737956c475afed0c8de592c5c57bf3');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_EniMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_eni_659db4820391ac47ebda3e45c48dd246fc737956c475afed0c8de592c5c57bf3');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_GroupeoMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_groupeo_659db4820391ac47ebda3e45c48dd246fc737956c475afed0c8de592c5c57bf3');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4MQeBJbR+S', 0, 'vEumi2qSk-L6GgEiax3lmT', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('QpRJAhH90p', NULL, 'vEumi2qSk-L6GgEiax3lmT', ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H3JDr5YRL-', 0, 'vEumi2qSk-L6GgEiax3lmT', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('594bfbdf5cc486.06105280');
    }
