 ...
 */
class Salle extends \EniBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EniBundle\\Entity\\Salle' . "\0" . 'libelle', '' . "\0" . 'EniBundle\\Entity\\Salle' . "\0" . 'capacite', '' . "\0" . 'EniBundle\\Entity\\Salle' . "\0" . 'lieu', '' . "\0" . 'EniBundle\\Entity\\Salle' . "\0" . 'codesalle'];
        }
