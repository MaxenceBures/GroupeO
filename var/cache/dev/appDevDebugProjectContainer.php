...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_EniConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.eni_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'localhost\\CLAAS', 'port' => NULL, 'dbname' => 'ENI_db', 'user' => 'Alois', 'password' => 'Test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Dbal_GroupeoConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.groupeo_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'localhost\\CLAAS', 'port' => NULL, 'dbname' => 'GroupeO', 'user' => 'Alois', 'password' => 'Test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['cache.serializer.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3u5U3S2SSt', 0, 'IKEl9B4XB-WT8Nw+wQs-R1', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g1kb67ILlG', 0, 'IKEl9B4XB-WT8Nw+wQs-R1', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('595517c27f2b82.67494283');
    }
